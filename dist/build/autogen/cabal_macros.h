...
/* package Dominitry-0.1.0.0 */
#define VERSION_Dominitry "0.1.0.0"
#define MIN_VERSION_Dominitry(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package data-partition-0.3.0.0 */
#define VERSION_data_partition "0.3.0.0"
#define MIN_VERSION_data_partition(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
...
#define CURRENT_COMPONENT_ID "Dominitry-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Dominitry-0.1.0.0"
